...
public class DataSaver {
    ...
    public void createCalculatedRetestMetrics(String filename) throws IOException {
        FileWriter fileWriter = new FileWriter(filename);
        fileWriter.append("Id_Retest,Id_Sample,ClassifiersResult,TrueResult,Metric\n");
        fileWriter.flush();
        fileWriter.close();
    }
    ...
    public void buildRetestMetricsCSV(String file, String idRetest, int id_sample, double classifiersResult, double trueResult, String metric) throws IOException {
        FileWriter fileWriter = new FileWriter(file, true);
        fileWriter.append(idRetest + "," + id_sample + "," + classifiersResult + "," + trueResult + "," + metric + "\n");
        fileWriter.flush();
        fileWriter.close();
    }
